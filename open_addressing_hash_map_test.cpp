...
TEST(OpenAddressingHashMap, Basic) {
  OpenAddressingHashMap<std::string, int> map(10);
...
TEST(OpenAddressingHashMap, Rehashing) {
  OpenAddressingHashMap<std::string, int> map(4);
  for (int i = 0; i < 100; i++) {
